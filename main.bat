...
set ENVNAME=eppley-bot

rem The following command activates the base environment.
rem call C:\ProgramData\Miniconda3\Scripts\activate.bat C:\ProgramData\Miniconda3
if %ENVNAME%==base (set ENVPATH=%CONDAPATH%) else (set ENVPATH=C:\Users\rober\.conda\envs\eppley-bot)
...
python3 "C:\Users\rober\Google Drive\PersonalProjects\Symptoms-Monitoring-Bot\main.py"
